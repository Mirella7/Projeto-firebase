...
export function Login({ navigation }) {
    ...
    async function fazerLogin() {
        if (email == '') {
            ...
            if (resultado == 'sucesso') {
                navigation.navigate('ListarProdutos', { email: email }) //replace apaga as telas anteriores da pilha. Caso o usuário clique no voltar do celular não volta para a tela de login
            } else
    ...
    return (
        <View style={estilos.container}>
            ...
            <Text style={estilos.texto}> Clique no link a seguir para:
